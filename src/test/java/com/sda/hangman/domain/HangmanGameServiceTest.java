...
public class HangmanGameServiceTest {
    ...
    @Test
    public void should_return_empty_array_for_no_existing_character_in_phrase() {
        //given
        HangmanGameService hangmanGameService = new HangmanGameService();
        //when
    ...
    @Test
    public void should_return_array_with_character_indexes_from_phrase_containing_white_spaces() {
        //given
        HangmanGameService hangmanGameService = new HangmanGameService();
        //when
